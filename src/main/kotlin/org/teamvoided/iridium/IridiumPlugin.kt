...
class IridiumPlugin: Plugin<Project> {
    override fun apply(project: Project) {
        ...
        IridiumLoader.loadFrom(project.projectDir.resolve("gradle/iridium/iridium").absoluteFile, false)
        val iridiumExtension: IridiumExtension = project.extensions.create("iridium", IridiumExtension::class.java)

        project.afterEvaluate {
            if (!iridiumExtension.dirty) IridiumLoader.loadFrom(project.projectDir.resolve("gradle/iridium/iridium").absoluteFile, true)
        }
    }
}